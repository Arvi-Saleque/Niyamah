...
export function SiteHeader({ className }: SiteHeaderProps) {
  ...
  return (
    <>
      <header
        className={cn(
          "sticky top-0 z-40 border-b border-[#D6DDCF]/90 bg-[#FAF7EE]/88 backdrop-blur-xl",
          className,
        )}
      >
        <Container>
          <div className="flex h-[72px] items-center gap-5">
            ...
            <div className="ml-auto flex items-center gap-1">
              <button
                ...
                className="hidden h-10 min-w-[280px] items-center gap-2 rounded-full border border-[#D6DDCF] bg-white px-4 text-left text-sm text-[#687464] shadow-sm transition-colors hover:border-[#007A3D] lg:flex"
              >
      ...
      >
        <div
          className={cn(
            "mx-auto mt-16 max-w-2xl overflow-hidden rounded-[28px] border border-[#D6DDCF] bg-white shadow-2xl transition-transform",
        ...
        >
          <form
            ...
            className="flex items-center gap-2 border-b border-[#D6DDCF] p-3"
          >
              ...
              <div className="grid gap-2">
                {([
                  ...
                  <Link
                    ...
                    href={href}
                    onClick={() => setSearchOpen(false)}
                    className="rounded-xl border border-[#D6DDCF] px-3 py-2 text-sm font-semibold text-[#162018] hover:border-[#007A3D] hover:bg-[#EAF6DD]"
                  >
                    {label}
                  </Link>
                ))}
      ...
      <div className="flex flex-wrap gap-2">
        {items.map((item) => (
          <button
            ...
            type="button"
            onClick={() => onPick(item)}
            className="rounded-full border border-[#D6DDCF] bg-[#FAF7EE] px-3 py-2 text-xs font-semibold text-[#162018] hover:border-[#007A3D] hover:text-[#007A3D]"
          >
            {item}
          </button>
        ))}
