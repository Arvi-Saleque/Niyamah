      ...
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--color-text-secondary)]">
            ...
            <span className="font-semibold"> Feature columns</span> (image + heading + sub-links, like NEW),
            <span className="font-semibold"> Mega list</span> (heading + flat link list, like Men/Women), or
            <span className="font-semibold"> Image tiles</span> (square image grid, like Art of Living).
            The first slot (NEW) is pinned and always visible.
          </p>
        </div>
