      ...
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--color-text-secondary)]">
            A simple visual editor for the homepage. Change the words, links, offers, support copy,
            and trust messages without touching code. Saved changes appear on the storefront after
            the 5 minute cache refresh.
          </p>
        </div>
      </header>
      <HomepageManager />
