...
DO $$ BEGIN
  ALTER TABLE "homepage_blocks" ADD CONSTRAINT "homepage_blocks_store_id_stores_id_fk" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "newsletter_subscribers" ADD CONSTRAINT "newsletter_subscribers_store_id_stores_id_fk" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "homepage_blocks_store_key_uniq" ON "homepage_blocks" USING btree ("store_id","block_key");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "newsletter_store_email_idx" ON "newsletter_subscribers" USING btree ("store_id","email");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "newsletter_store_idx" ON "newsletter_subscribers" USING btree ("store_id");